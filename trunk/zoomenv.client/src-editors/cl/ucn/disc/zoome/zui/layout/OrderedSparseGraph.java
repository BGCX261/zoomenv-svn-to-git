...
// This class derived from SparseGraph was modified to keep the order or vertices and edges
...
public class OrderedSparseGraph<V,E> 
    ...
    implements Graph<V,E>
{
     ...
     * Creates an instance.
     */
    public OrderedSparseGraph()
    {
        vertex_maps = new LinkedHashMap<V, Map<V,E>[]>();
        directed_edges = new LinkedHashMap<E, Pair<V>>();
        undirected_edges = new LinkedHashMap<E, Pair<V>>();
    }
